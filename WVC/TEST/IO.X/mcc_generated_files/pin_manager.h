...
*/
#define PWRKEY_SetHigh()          _LATB13 = 1
/**
  @Summary
...
*/
#define PWRKEY_SetLow()           _LATB13 = 0
/**
  @Summary
...
*/
#define PWRKEY_Toggle()           _LATB13 ^= 1
/**
  @Summary
...
*/
#define PWRKEY_SetDigitalInput()  _TRISB13 = 1
/**
  @Summary
...
*/
#define PWRKEY_SetDigitalOutput() _TRISB13 = 0
/**
  @Summary
...
*/
#define GPRS_EN_SetHigh()          _LATB9 = 1
/**
  @Summary
...
*/
#define GPRS_EN_SetLow()           _LATB9 = 0
/**
  @Summary
...
*/
#define GPRS_EN_Toggle()           _LATB9 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB9
    postValue = GPRS_EN_GetValue();
    </code>

*/
#define GPRS_EN_GetValue()         _RB9
/**
  @Summary
  ...
  @Example
    ...
    GPRS_EN_SetDigitalInput();
    </code>

*/
#define GPRS_EN_SetDigitalInput()  _TRISB9 = 1
/**
  @Summary
  ...
  @Example
    ...
    GPRS_EN_SetDigitalOutput();
    </code>

*/
#define GPRS_EN_SetDigitalOutput() _TRISB9 = 0
