...
extern void DisplayTempC(void);
extern void DisplayTempF(void);
extern void  DisplayRTCC(void);
extern void UpdateBanner();
extern void UpdateHrsWeek(void);
extern unsigned char DIG0,DIG1,DIG2,TCDIG0,TCDIG1,TCDIG2,TFDIG0,TFDIG1,TFDIG2;
extern unsigned char MIN0,MIN1,SEC0,SEC1,HRS0,HRS1,WK;
extern unsigned short MINSEC0,WKHRS;
