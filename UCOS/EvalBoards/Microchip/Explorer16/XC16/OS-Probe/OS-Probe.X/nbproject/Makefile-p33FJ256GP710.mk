...
ifeq "$(wildcard nbproject/Makefile-local-p33FJ256GP710.mk)" "nbproject/Makefile-local-p33FJ256GP710.mk"
include nbproject/Makefile-local-p33FJ256GP710.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-p33FJ256GP710.mk dist/${CND_CONF}/${IMAGE_TYPE}/OS-Probe.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/OS-Probe.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/OS-Probe.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--heap=500,--stack=2000,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="../../../../../../../../../Program Files/Microchip/MPLAB C30/lib",--library-path="D:/MicroOS/Microchip Projects/dspic710/Micrium/Software/EvalBoards/Microchip/Explorer16/PIC33FJ256/MPLAB_C30/BSP",--library-path=".",--no-force-link,--smart-io,--report-mem$(MP_EXTRA_LD_POST) 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/p33FJ256GP710
	${RM} -r dist/p33FJ256GP710
