...
void RTCC_Initialize(void) {
    ...
    // set Sat Aug 19 16:46:57 CST 2017
    RCFGCALbits.RTCPTR = 3; // start the sequence
    RTCVAL = 0x17; // YEAR
    RTCVAL = 0x819; // MONTH-1/DAY-1
    RTCVAL = 0x616; // WEEKDAY/HOURS
    RTCVAL = 0x4657; // MINUTES/SECONDS
    ...
    // ALRMEN enabled; ARPT 0; AMASK Every 10 Second; CHIME enabled; ALRMPTR MIN_SEC; 
    ALCFGRPT = 0xC800;
