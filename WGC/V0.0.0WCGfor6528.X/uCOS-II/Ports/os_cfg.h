...
#define OS_LOWEST_PRIO           12u   /* Defines the lowest priority that can be assigned ...         */
/* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS             4u   /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS              9u   /* Max. number of tasks in your application, MUST be >= 2       */
