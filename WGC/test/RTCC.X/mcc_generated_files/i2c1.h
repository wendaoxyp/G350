...
extern "C" {
    ...
    void DRV_I2C1_MasterWrite(
            ...
            uint8_t length,
            uint16_t address,
            DRV_I2C1_MESSAGE_STATUS *pstatus) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C1_MasterWrite instead. ")));
    ...
    void DRV_I2C1_MasterTRBInsert(
            uint8_t count,
            DRV_I2C1_TRANSACTION_REQUEST_BLOCK *ptrb_list,
            DRV_I2C1_MESSAGE_STATUS *pflag) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C1_MasterTRBInsert instead. ")));
    ...
    void DRV_I2C1_MasterReadTRBBuild(
            ...
            uint8_t *pdata,
            uint8_t length,
            uint16_t address) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C1_MasterReadTRBBuild instead. ")));
    ...
    void DRV_I2C1_MasterWriteTRBBuild(
            ...
            uint8_t *pdata,
            uint8_t length,
            uint16_t address) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C1_MasterWriteTRBBuild instead. ")));
     ...
     */
    bool DRV_I2C1_MasterQueueIsEmpty(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C1_MasterQueueIsEmpty instead. ")));
     ...
     */
    bool DRV_I2C1_MasterQueueIsFull(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C1_MasterQueueIsFull instead. ")));
