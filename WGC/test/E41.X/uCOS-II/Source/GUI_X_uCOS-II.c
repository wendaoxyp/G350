...
*
*                          (c) Copyright 2002-2013, Micrium Inc., Weston, FL
*                     (c) Copyright 2002-2008, SEGGER Microcontroller Systems GmbH
*
...
*                                          TIMING FUNCTIONS
*
* Notes: Some timing dependent routines of uC/GUI require a GetTime and delay function.
