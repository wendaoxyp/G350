...
void I2C1_Initialize(void) {
    ...
    // Calculated Frequency: 100,251 Hz
    I2C1BRG = 0x009D;
    // RCEN disabled; A10M 7 Bit; RSEN disabled; ACKEN disabled; DISSLW enabled; SCLREL Holds; SEN disabled; ACKDT Sends ACK; GCEN disabled; SMEN disabled; PEN disabled; I2CEN disabled; I2CSIDL disabled; STREN disabled; IPMIEN disabled; 
    I2C1CON = 0x0000;
