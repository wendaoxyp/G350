...
static void Task5UseCAT24C512(void* parg);
...
CPU_INT16S main(void) {
    ...
    OSTaskCreate(Task5UseCAT24C512, (void*) 0, (OS_STK*) & I2CStk[0], 6);
...
void Task5UseCAT24C512(void* parg) {
    ...
    uint8_t tmp[]={0x00,0x11,0x22,0x33};
    uint8_t tmp1[5];
    while (1) {
        CAT24C512_Write(0x02,tmp);
        OSTimeDlyHMSM(0,0,3,0);
        CAT24C512_Read(0x02,tmp1);        
        OSTimeDlyHMSM(0,0,3,0);
        tmp[0]=1;
        //等待使用互斥量信号
        //通过邮箱判断存储还是读取
