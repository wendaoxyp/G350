...
/*static*/ u8 Register2[REG2_BYTES] = {
    0x08, 0x7F, 0xF9, 0x02, 0x01, 0x00, 0x00, 0x00, 0x09, 0x02, //miot地址、miotId号、设备地址
    0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x20, 0x17, 0x05, 0x02, //设备ID号、时间
    0x00, 0x00, 0x00, 0x00, 0x0A, 0x00, 0x0A, 0x00, 0x00, 0x01, //采集时间、上传时间、报警时间、接入设备类型
    0x04, 0x00, 0x01, 0x03, 0x42, 0xF0, 0x00, 0x00, 0x42, 0xB4, //公称直径、SSP、主从模式、通讯协议、高压报警
    0x00, 0x00, 0x42, 0x48, 0x00, 0x00, 0x40, 0xA0, 0x00, 0x00, //低压报警、高温报警、低温报警
    0x40, 0x0A, 0xE1, 0x48, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff //电压、脉冲总数、定时上传时间
};

const u8 REG2_Arg_Postion[REG2_ARG_NUM + 1] = {
    0, 1, 9, 10, 16, 18, 19, 20, 21, 22,
    23, 25, 27, 29, 30, 31, 32, 33, 34, 38,
    42, 46, 50, 54, 58, 59, 60
};
