...
#define FCY     4000000	//Instruction clock speed (Fosc/2)
...
#define UTX_ANA		ANSBbits.ANSB0//AD1PCFGbits.PCFG2 UART2
#define URX_ANA		ANSBbits.ANSB1//AD1PCFGbits.PCFG4
...
#elif   defined(__PIC24F32KA302__)
...
#elif defined(__PIC24FK__)  //PIC24F "K" type devices
    #define PM_PAGE_ERASE 		0x4058	//NVM page erase opcode ¼ûNVMCON ÉÁ´æ¿ØÖÆ¼Ä´æÆ÷ ²Á³ýÉÁ´æ1ÐÐ
    #define PM_ROW_WRITE 		0x4004	//NVM row write opcode  Ð´ÉÁ´æÒ»ÐÐ
#endif
