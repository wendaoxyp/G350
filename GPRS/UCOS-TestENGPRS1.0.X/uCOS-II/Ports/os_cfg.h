...
#define OS_LOWEST_PRIO            4u   /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            1u   /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS             2u   /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_Q_QUERY_EN             0u   /*     Include code for OSQQuery()                              */
                                       ...
                                       /* ------------------------ SEMAPHORES ------------------------ */
#define OS_SEM_EN                 0u   /* Enable (0) or Disable (0) code generation for SEMAPHORES     */
...
#define OS_TMR_CFG_MAX            2u   /*     Maximum number of timers                                 */
