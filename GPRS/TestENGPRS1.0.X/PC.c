...
//    Register2Read(&head, mi_arg_add[mi_add], 1); //获取帧头
//
//    do {//10s判断是否进入参数设置
...
//        Register2Write(receiveData + 2, mi_arg_add[mi_ofst], 4); //写入脉冲量
//        Register2Write(receiveData + 6, mi_arg_add[mi_year], 7); //写入时间
//        StopRTCC();
//        CheckRTCC();
//        StartRTCC();
