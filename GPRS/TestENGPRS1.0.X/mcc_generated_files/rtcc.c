...
void RTCC_Initialize(void) {
    ...
    // set Tue Feb 07 22:48:26 CST 2017
    RCFGCALbits.RTCPTR = 3; // start the sequence
    RTCVAL = 0x17; // YEAR
    RTCVAL = 0x207; // MONTH-1/DAY-1
    RTCVAL = 0x222; // WEEKDAY/HOURS
    RTCVAL = 0x4826; // MINUTES/SECONDS
    ...
    // ALRMEN enabled; ARPT 0; AMASK Every SEC; CHIME enabled; ALRMPTR MIN_SEC; 
    ALCFGRPT = 0xC400;
