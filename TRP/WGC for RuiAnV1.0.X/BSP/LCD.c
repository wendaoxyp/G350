...
void NUM_SHOW(uint8_t num, uint8_t pos) {
...
void ShowPressure1(void) {//显示压力值
    ...
    zs1 = floor(f_p);
    //    zs1 = pressure10;
    dp1 = (uint32_t) (f_p * 100) % 100;
    //    pressure10 = zs1 * 100 + dp1;
    //    pressure10 = zs1 * 100 + dp1;
    //    pressure10 = 1234;
    ClrScreen();
    if (!zs1) {//如果压力值为0
        NUM_SHOW(0, 3);
        //        NUM_SHOW(dp1 / 10 % 10, 1);
        //        NUM_SHOW(dp1 % 10, 0);
        //        NUMS_SHOW((uint32_t) pressure10, 0);
        //        W_LCDCON.LCD_Flagbits.F_DP = 3;
        //    } else {
    ...
    //        tmp1=
    //        NUM_SHOW(zs1 / 1000 % 10, 4);
    //        NUM_SHOW(zs1 / 100 % 10, 4);
    //        NUM_SHOW(zs1 / 10 % 10, 4);
    //        NUM_SHOW(zs1 % 10, 3);
    //    W_LCDCON.LCD_Flagbits.F_KPa = 1;
    //    W_LCDCON.LCD_Flagbits.F_Num = 1;
    //    LCD_Task(pressure10); //执行LCD刷新任务
