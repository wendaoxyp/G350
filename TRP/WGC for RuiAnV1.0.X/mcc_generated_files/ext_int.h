...
#define DRV_EX_INT0_InterruptFlagClear()       (IFS0bits.INT0IF = 0)
    /**
      @Summary
...
#define DRV_EX_INT0_InterruptDisable()     (IEC0bits.INT0IE = 0)
    /**
      @Summary
        Clears the interrupt enable for INT0
...
#define DRV_EX_INT0_InterruptEnable()       (IEC0bits.INT0IE = 1)
    /**
      @Summary
...
#define DRV_EX_INT0_NegativeEdgeSet()          (INTCON2bits.INT0EP = 1)
    /**
      @Summary
...
#define DRV_EX_INT0_PositiveEdgeSet()          (INTCON2bits.INT0EP = 0)
