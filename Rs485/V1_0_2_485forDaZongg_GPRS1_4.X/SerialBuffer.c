...
void BufferWrite_UART1(void) {
    ...
    bufferWptr_uart1++;
    bufferWptr_uart1 = bufferWptr_uart1 % BUFFERMAX1; // - ((bufferWptr_uart1 >> 8) << 8);
...
void BufferWrite_UART2(void) {
    ...
    bufferWptr_uart2++;
    bufferWptr_uart2 = bufferWptr_uart2 % BUFFERMAX2; //- ((bufferWptr_uart2 >> 6) << 6); //bufferWptr_uart2%BUFFERMAX
...
bool BufferRead_UART1(u8 *data) {
    ...
    *data = Buffer_uart1[bufferRptr_uart1];
    bufferRptr_uart1++;
    bufferRptr_uart1 = bufferRptr_uart1 % BUFFERMAX1; // - ((bufferRptr_uart1 >> 6) << 6); //bufferRptr_uart1 % BUFFERMAX; 
...
bool BufferRead_UART2(u8 *data) {
    ...
    *data = Buffer_uart2[bufferRptr_uart2];
    bufferRptr_uart2++;
    bufferRptr_uart2 = bufferRptr_uart2 % BUFFERMAX2; //- ((bufferRptr_uart2 >> 6) << 6);
