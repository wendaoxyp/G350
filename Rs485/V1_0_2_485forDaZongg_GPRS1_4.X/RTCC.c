...
void CheckRTCC(void) {
    ...
    //    u8 miotArgs.mi_time[7] = {0, 0, 0, 0, 0, 0, 0};
    //    Register2Read(miotArgs.mi_time, REG2_Arg_Postion[mi_year], 7); //0x14 0x11
    //    miotArgs.mi_time[0] = DCH(miotArgs.mi_time[0]); //20->0x20
    //    miotArgs.mi_time[1] = DCH(miotArgs.mi_time[1]);
    //    miotArgs.mi_time[2] = DCH(miotArgs.mi_time[2]);
    //    miotArgs.mi_time[3] = DCH(miotArgs.mi_time[3]);
    //    miotArgs.mi_time[4] = DCH(miotArgs.mi_time[4]);
    //    miotArgs.mi_time[5] = DCH(miotArgs.mi_time[5]);
    //    miotArgs.mi_time[6] = DCH(miotArgs.mi_time[6]);
    //    Nop();
    ...
    RTCVAL = miotArgs.mi_time[1] & 0x00FF; //0x0016; //年份  2016.6.1. 3 13:10:10
    RTCVAL = (miotArgs.mi_time[2] << 8) + miotArgs.mi_time[3]; //0x1022; //月份 日期
    RTCVAL = miotArgs.mi_time[4] & 0x00FF; //0x0008; //星期  小时
    RTCVAL = (miotArgs.mi_time[5] << 8) + miotArgs.mi_time[6]; //0x3050; //分钟 秒 
