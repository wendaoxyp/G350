...
void ADC1_Initialize(void) {
    // ADSIDL disabled; ASAM enabled; FORM Absolute decimal result, unsigned, right-justified; MODE12 disabled; ADON enabled; DONE disabled; SAMP disabled; SSRC Internal counter ends sampling and starts conversion; 
    ...
    // ADRC RC clock; SAMC 5; EXTSAM disabled; ADCS 0; 

    AD1CON3 = 0x8500;

    // CH0SA AN0; CH0SB AN0; CH0NB AVSS; CH0NA AN0; 
