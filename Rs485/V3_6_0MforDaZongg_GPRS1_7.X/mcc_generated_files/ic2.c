...
/**
  ...
  @Summary
    This is the generated source file for the IC2 driver using MPLAB? Code Configurator
...
void IC2_Initialize(void) {
    // ICM Interrupt mode; ICSIDL disabled; ICOV disabled; ICI Every; IC2TSEL TMR1; ICBNE disabled; 
    IC2CON1 = 0x1007;
    // IC32 disabled; ICTRIG enabled; SYNCSEL None; TRIGSTAT disabled; 
    IC2CON2 = 0x0080;
    // IC2BUF disabled; 
    IC2BUF = 0x0000;
    // IC2TMR disabled; 
