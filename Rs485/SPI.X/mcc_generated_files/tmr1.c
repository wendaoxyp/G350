...
#include <xc.h>
#include "tmr1.h"
extern volatile uint8_t DealyTime1;
/**
...
void TMR1_Initialize(void) {
    //TSIDL disabled; TGATE disabled; TCS FOSC/2; TSYNC disabled; TCKPS 1:256; TECS SOSC; TON enabled; 
    T1CON = 0x8030;
    //TMR1 0; 
    TMR1 = 0x0000;
    //Period Value = 1.000 s; PR1 15625; 
    PR1 = 0x3D09;
