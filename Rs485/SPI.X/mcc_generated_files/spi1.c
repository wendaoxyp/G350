...
void SPI1_Initialize(void) {
    // SPI Frequency = 3,906 Hz; PPRE 64:1; SMP Sample at Middle; MSTEN enabled; MODE16 disabled; DISSCK disabled; SPRE 8:1; CKE Idle to Active; DISSDO disabled; CKP Idle:Low, Active:High; 
    SPI1CON1 = 0x0020;
...
void SPI1_Exchange(uint8_t *pTransmitData, uint8_t *pReceiveData) {
    ...
    while (SPI1STATbits.SR1MPT == true);
