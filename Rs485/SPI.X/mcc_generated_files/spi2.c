...
void SPI2_Initialize(void) {
    // SPI Frequency = 16,000,000 Hz; PPRE 1:1; SMP Sample at Middle; MSTEN enabled; MODE16 disabled; DISSCK disabled; SPRE 1:1; CKE Active to Idle; DISSDO disabled; CKP Idle:Low, Active:High; 
    SPI2CON1 = 0x013F;
