...
void RTCC_Initialize(void) {
    ...
    // set Tue Feb 28 17:08:06 CST 2017
    RCFGCALbits.RTCPTR = 3; // start the sequence
    RTCVAL = 0x17; // YEAR
    RTCVAL = 0x228; // MONTH-1/DAY-1
    RTCVAL = 0x217; // WEEKDAY/HOURS
    RTCVAL = 0x806; // MINUTES/SECONDS
    ...
    // ALRMEN enabled; ARPT 0x00; AMASK Every Half Second; CHIME enabled; ALRMPTR MIN_SEC; 
    ALCFGRPT = 0xC000;
    // PWCPOL disabled; PWCEN disabled; RTCOUT Alarm Pulse; RTCCLK SOSC; 
    RTCPWC = 0x0000;
